# Generated by Django 4.0.3 on 2022-05-03 06:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_type', models.CharField(choices=[('once', 'Once'), ('weekly', 'Weekly'), ('monthly', 'Monthly')], default='once', max_length=16)),
            ],
            options={
                'ordering': ['-id'],
            },
